...
export const enMessages = {
  ...
  "event.research.repository_scan_started": "Repository scan started",
  "event.research.repository_scan_completed": "Repository scan completed",
  "event.research.repository_scan_partial": "Repository scan partially completed",
  "event.research.repository_context_confirmed": "Repository context confirmed",
...
export const zhCNMessages: Record<MessageKey, string> = {
  ...
  "event.connecting": "正在连接", "event.open": "已连接", "event.closed": "已关闭", "event.error": "连接错误", "event.unavailable": "不可用", "event.research.started": "研究已启动", "event.research.repository_scan_started": "开始扫描代码库", "event.research.repository_scan_completed": "代码库扫描完成", "event.research.repository_scan_partial": "代码库扫描部分完成", "event.research.repository_context_confirmed": "代码库上下文已确认", "event.research.plan_ready": "计划已就绪", "event.research.awaiting_clarification": "等待补充信息", "event.research.awaiting_approval": "等待确认", "event.research.resumed": "研究已恢复", "event.research.sources_collected": "已收集来源", "event.research.report_ready": "报告已就绪", "event.research.completed": "研究已完成", "event.research.failed": "研究失败",
